...
return [
    ...
    'notifikasi-peserta/{id}' => [
        'middleware' => 'Admin',
        'callback' => 'KuisController@notificationParticipantJson',
        'return'   => 'json'
    ],
    ...
    'admin/log-sms/resend' => [
        'middleware' => 'Admin',
        'callback' => 'HomeController@resendSms',
        'return'   => 'json'
    ],
    ...
    'admin/participant/get-all' => [
        'middleware' => 'Admin',
        'callback' => 'ParticipantController@getAll',
        'return'   => 'json'
    ],
