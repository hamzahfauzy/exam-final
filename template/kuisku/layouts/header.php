	...
	<div class="">
		<div class="top-flex">
			...
			<div class="top-account">
				...
				<a href="javascript:void(0)" class="nav-toggle" style="padding-top:18px;padding-bottom:18px" onclick="document.querySelector('.left-sidebar').classList.toggle('sidebar-toggle')"><i class="fa fa-bars fa-lg"></i></a>
			</div>
		</div>
	</div>
</div>