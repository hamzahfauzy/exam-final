<div style="padding-top: 50px;position:fixed;width:300px;">
    ...
    <?php else: ?>
        <li>
            <a href="<?= base_url()?>/participant?token=<?=$_GET['token']?>"><i class="fa fa-home fa-fw"></i> Beranda</a>
        </li>
        <li>
            <a href="<?= base_url()?>/logout?token=<?=$_GET['token']?>"><i class="fa fa-sign-out fa-fw"></i> Log Out</a>
        </li>
        <?php endif ?>
    </ul>
</div>