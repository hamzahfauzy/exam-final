        ...
        <div class="participant-info">
            <center>
                ...
                <?php if($currentSession): ?>
                    ...
                    <?php else: ?>
                    <a href="<?= route('participant/exam') ?>?token=<?=$_GET['token']?>" class="btn btn-success">Ikuti Ujian</a> <br><br>
                    <?php endif; ?>
                ...
                <?php elseif($nextSession): ?>
                    ...
                    <a href="#" class="btn btn-success">Ujian akan di laksanakan pada <?= (new \DateTime($nextSession->sesi->waktu_mulai))->format('d-m-Y H:i') ?> dan harap login kembali jika sudah memasuki waktu ujian</a> <br><br>
                    <table class="table table-bordered">
                        <tr>
                            <td>Nama Ujian</td>
                            <td><?= $kuis->post_title ?></td>
                ...
                |
                <a href="<?= route('logout') ?>?token=<?=$_GET['token']?>"><i class="fa fa-sign-out"></i> Log Out</a>
            </center>
        </div>
    </div>
...
async function changePassword(el)
{
    ...
    let request = await fetch('<?= route('change-password') ?>?token=<?=$_GET['token']?>',{
        method :'POST',
        headers : {
